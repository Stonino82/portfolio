		...
		<section class="presentation padding-600 opacityOnScroll ">
			<div class="presentation__central">
				...
				<div class="presentation__headlines margin-block-900">
					...
					<h1 class="entry-title fs-primary-heading fw-bold tt-up tc-neutral-700">Design & Code Dialogues</h1>
					<h2 class="fs-secondary-heading fw-regular tc-primary margin-block-500">Dive into the world of UX, UI, and Front-end Development! I'll share insights, explore trends, and spark conversation on everything from user research to pixel-perfect interfaces.</h2>
				</div>
			</div>
