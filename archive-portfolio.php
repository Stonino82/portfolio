		...
		<section class="presentation padding-600 opacityOnScroll ">
			...
			<div class="presentation__central">
				...
				<div class="presentation__headlines margin-block-700">
					...
					<h1 class="entry-title fs-display-1 fw-bold margin-0">Case Studies & Designs Showcase</h1>
					<h2 class="fs-body fw-regular margin-block-500">Discover my design journey! This portfolio features UX Case Studies and UI Designs, showcasing my approach to user-centered design and the final, polished results.</h2>
				</div>
			</div>
